...
class ViewControllerPro: NSViewController {
    ...
    @IBOutlet weak var buttonPi: NSButton!
    @IBOutlet weak var buttonE: NSButton!
    @IBOutlet weak var buttonSqrt: NSButton!
    @IBOutlet weak var buttonSquared: NSButton!
    ...
    */
    ...
    @IBAction func pushPi(_ sender: Any) {
        addDigit("3.141592653589793")
    }
    
    @IBAction func pushE(_ sender: Any) {
        addDigit("2.718281828459045")
    }
    
    @IBAction func pushSqrt(_ sender: Any) {
        var tmp = Double(field.stringValue)
        if tmp != nil && tmp! >= 0.0 {
            tmp = sqrt(tmp!)
            result = tmp
            counted = true
    ...
    @IBAction func pushSquared(_ sender: Any) {
        var tmp = Double(field.stringValue)
        if tmp != nil {
            tmp = tmp! * tmp!
            result = tmp
